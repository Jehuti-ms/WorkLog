...
// ============================================================================
// DEBUG AND FIX BI-WEEKLY BUTTON - ADD THIS TO app.js
// ============================================================================

function debugBiWeeklyButton() {
    console.log('🔧 Debugging Bi-Weekly button...');
    
    // Find all buttons
    const buttons = document.querySelectorAll('.btn');
    console.log('📋 Total buttons found:', buttons.length);
    
    // Find the bi-weekly button
    const biWeeklyBtn = Array.from(buttons).find(btn => 
        btn.textContent.includes('Bi-Weekly') || 
        btn.textContent.includes('Bi-Weekly')
    );
    
    console.log('🔘 Bi-Weekly button:', biWeeklyBtn);
    
    if (biWeeklyBtn) {
        console.log('✅ Bi-Weekly button found, checking onclick:', biWeeklyBtn.onclick);
        
        // Force set the onclick handler
        biWeeklyBtn.onclick = function() {
            console.log('🎯 Bi-Weekly button clicked - FORCE EXECUTING');
        ...
        console.log('❌ Bi-Weekly button not found');
        
        // Try to find by text content
        const allText = Array.from(buttons).map(btn => btn.textContent);
        console.log('📝 All button texts:', allText);
    }
}

// Auto-run the debug when page loads
setTimeout(debugBiWeeklyButton, 2000);
